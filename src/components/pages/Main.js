            ...
            <Container>
                ...
                <div className="category-block">
                    ...
                    <div >
                        <Row xs={2} md={4} className="g-4">
                            <Col  >
                                <CardCategory Title={"Бензопилы"} Img={chainsawCard}></CardCategory>
                            </Col>
                            <Col>
                                <CardCategory Title={"Триммеры"} Img={trimmerCard}></CardCategory>
                            </Col>
                            <Col>
                                <CardCategory Title={"Запчасти"} Img={sparcesCard}></CardCategory>
                            </Col>
                            <Col>
                                <CardCategory Title={"Велосипеды"} Img={bicyclesCard}></CardCategory>
                            </Col>
                ...
                <div className="mt-5">
                    <Row xs={2} md={8} className="g-4">
                        <Col md={6}>
                            <img width="600" src={require('../../img/dostav.jpg')} alt=""/>
                        </Col>
                        <Col md={6}>
